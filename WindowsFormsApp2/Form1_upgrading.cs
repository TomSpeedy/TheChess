...
namespace WindowsFormsApp2
{
    ...
    public partial class TheChess : Form
    {
        ...
        public int CountMoves(ChessPiece[,] chess_state/*, List<ChessPiece> list*/)
        {
            int sum = 0;
            /*
        ...
        {
            int guess = Max(ref game_state, 0, 2, -35000, 35000);
            first_call = true;
        ...
        public int Max(ref ChessPiece[,] state, int depth, int final_depth, int alpha, int beta)
        {
            ...
            if ((first_call == true) && (number_of_moves != 0) && (depth != final_depth))
            {
                first_call = false;
                bool w_l_r_backup = castling.w_l_rook_not_moved;
                bool w_r_r_backup = castling.w_r_rook_not_moved;
        ...
        public void FillPiecesToList(ref ChessPiece[,] board, ref List<ChessPiece> pieces)
        {
            for (int i = 0; i < 8; i++)
            {
                for (int j = 0; j < 8; j++)
